                ...
                <div className="max-w-6xl w-full grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                    ...
                    <div className="space-y-6 text-center lg:text-left">
                        <h1 className="text-3xl lg:text-5xl font-bold text-black dark:text-white leading-tight">
                            Hé Lô mấy đứa <br />
                            <span className="text-primary">Abe Trà Cú</span> tới đây !!!
                        </h1>

                        <div className="space-y-4 text-gray-700 dark:text-gray-300 text-lg leading-relaxed">
                            <p>
                                Chào mừng mấy đứa đã lạc trôi vào cái "ổ" phim ảnh của tụi anh!
                            </p>
                            <p>
                                Nơi đây là thánh địa dành cho những tâm hồn đồng điệu, những
                                người có thể ngồi cày phim xuyên màn đêm, mặc kệ deadline đang
                                gào thét hay sếp đang réo gọi (đùa đấy, nhớ làm việc nha mấy
                                fen).
                            </p>
                            <p>
                                Từ bom tấn Hollywood cháy nổ đùng đùng 💥, drama Hàn Quốc khóc
                                hết nước mắt 😭, cho đến Anime cute phô mai que 🧀 hay phim
                                kinh dị làm bạn không dám đi vệ sinh ban đêm 👻. Tất cả đều
                                được tuyển chọn và cập nhật bằng cả trái tim và đôi mắt thâm
                                quầng của đội ngũ Abe Trà Cú.
                            </p>
                            <p className="italic text-black/80 dark:text-white/80 font-medium">
                                "Mục tiêu của chúng mình không chỉ là web xem phim, mà là nơi để
                                chúng ta cùng chill, cùng bàn luận và cùng nhau trốn khỏi thực
                                tại phũ phàng (một chút thôi)."
                            </p>
