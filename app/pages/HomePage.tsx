...
export default function HomePage() {
	...
	return (
		<>
			...
			{/* Footer */}
			<footer className='border-t border-white/5 bg-[#0a0a15] mt-10'>
				<div className='w-full px-4 lg:px-32 py-12'>
					<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
						{/* Brand */}
						<div className='space-y-4'>
							<div className='flex items-center gap-2'>
								<div className='bg-primary text-black font-black text-xl px-2.5 py-1 rounded-lg'>
									R
								</div>
